...
## Overview
Code that support the tutorial [Integration with TravisCI](https://docs.getxray.app/display/XRAYCLOUD/Integration+with+Travis+CI) showcasing the integration between [Xray Test Management](https://www.getxray.app/) and [TravisCI](https://travis-ci.com/) using Java and JUnit.
...
This can be achieved using [Xray Test Management](https://www.getxray.app/) as shown in further detail in this [tutorial](https://docs.getxray.app/display/XRAYCLOUD/Integration+with+Travis+CI).
